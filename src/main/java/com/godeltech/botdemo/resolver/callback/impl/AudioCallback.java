...
public class AudioCallback implements CallbackType {
    private final ApplicationEventPublisher applicationEventPublisher;

    @Override
    public String getCallbackName() {
        return Callbacks.AUDIO.name();
    }
    ...
    public BotApiMethod createMethod(CallbackQuery callbackQuery) {
        applicationEventPublisher.publishEvent(CustomEvent.builder()
                ...
                .build());
        return BotUtil.getMainSendMessage(callbackQuery.getMessage(),"Audio was sent");
    }
}
